 ...
 */
public protocol TinyPlayer: AnyObject {
    
    var delegate: TinyPlayerDelegate? { get set } // Conforming classes should declare this as `weak`
 ...
 */
public protocol TinyPlayerDelegate: AnyObject, Sendable {
